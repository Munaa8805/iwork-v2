                ...
                @enderror
                    ...
                    <div class="mb-4">
                        ...
                        <select
                            id="job_type"
                            name="job_type"
                            class="w-full px-4 py-2 border rounded @error('job_type') border-red-500 @enderror focus:outline-none"
                        >
                ...
                @enderror
                    ...
                    <div class="mb-4">
                        ...
                        <input
                            ...
                            type="text"
                            name="company_name"
                            class="w-full px-4 py-2 border rounded @error('company_name') border-red-500 @enderror focus:outline-none"
                ...
                @enderror
                    ...
                    <div class="mb-4">
                        ...
                        <input
                            ...
                            type="text"
                            name="contact_phone"
                            class="w-full px-4 py-2 border rounded @error('contact_phone') border-red-500 @enderror   focus:outline-none"
                ...
                @enderror
                    ...
                    <div class="mb-4">
                        ...
                        <input
                            ...
                            type="email"
                            name="contact_email"
                            class="w-full px-4 py-2 border rounded @error('contact_email') border-red-500 @enderror  focus:outline-none"
